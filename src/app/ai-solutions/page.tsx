...
export default function AISolutionsPage() {
  ...
  return (
    <>
      ...
      >
        {/* Background Orbs */}
        <div className="absolute top-[-200px] right-[-100px] w-[600px] h-[600px] bg-gradient-radial from-[#3b82f6] to-transparent rounded-full blur-3xl opacity-40 animate-ambientPulse" style={{ animationDelay: '0s' } as React.CSSProperties}></div>
        <div className="absolute bottom-[-100px] left-[-100px] w-[400px] h-[400px] bg-gradient-radial from-[#22d3ee] to-transparent rounded-full blur-3xl opacity-40 animate-ambientPulse" style={{ animationDelay: '-4s' } as React.CSSProperties}></div>
        <div className="absolute top-[40%] left-[30%] w-[350px] h-[350px] bg-gradient-radial from-[#8b5cf6] to-transparent rounded-full blur-3xl opacity-40 animate-ambientPulse" style={{ animationDelay: '-8s' } as React.CSSProperties}></div>
